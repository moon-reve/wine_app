...
import searchCamera from '../assets/quick-flow/search-camera.webp'
import searchThumb from '../assets/quick-flow/search-thumb.webp'
import searchResultWine from '../assets/quick-flow/search-result-wine.webp'
