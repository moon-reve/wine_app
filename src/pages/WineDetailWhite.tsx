...
export default function WineDetailWhite() {
  ...
  const { wine, wineReviews, similarWines, reviewKeywords, typeLabel } = getWineDetailData(wineId ?? 'wine_025')
  ...
  return (
    <div className="w-screen overflow-hidden bg-white pt-[env(safe-area-inset-top)] font-pretendard text-[#0d0d0d]" data-node-id="1546:5963">
