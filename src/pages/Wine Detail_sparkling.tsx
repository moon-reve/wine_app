...
export default function WineDetailSparkling() {
  ...
  return (
    <div className="mx-auto w-full max-w-[430px] overflow-hidden bg-white pt-[env(safe-area-inset-top)] font-pretendard text-[#0d0d0d]" data-node-id="1714:21">
      <div className="relative h-[3313px] w-full">
      ...
      <div className="absolute top-[135px] left-[-143px] z-0 h-[574px] w-[573px] rotate-180 overflow-hidden" aria-hidden="true">
        <img src={bubbles} alt="" className="size-full object-cover" />
      </div>
      <div className="absolute top-[169px] left-[20px] z-[1] h-[556px] w-[156px]">
        <img src={heroWineImage} alt={wine.nameKo} className="absolute top-0 left-1/2 h-full w-auto max-w-none -translate-x-1/2 object-contain" />
      </div>
      <div className="absolute top-[455px] left-[320px] z-[1] h-[523px] w-[181px] -rotate-[41.74deg] overflow-hidden" aria-hidden="true">
