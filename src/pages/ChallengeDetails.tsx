...
function ChallengeDetails() {
  ...
  return (
    <div className="h-dvh w-screen overflow-x-hidden overflow-y-auto bg-white pt-[env(safe-area-inset-top)] text-[#0d0d0d]" data-node-id="1542:1678">
      ...
      <section className="absolute inset-x-0 top-0 h-[768px] overflow-hidden" aria-label="대륙별 진행 현황">
        ...
        {[41.281, 58.481, 76.091].map((left, index) => (
          <img key={left} src={ghostBottle} alt={`${index + 3}번째 미완료 대륙`} className="absolute top-[529px] h-[218px] w-[15.116%] object-bottom opacity-45" style={{ left: `${left}%` }} />
        ))}
