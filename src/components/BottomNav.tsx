...
function NavButton({
  ...
  return (
    <button
      ...
      className={`flex h-14 min-w-12 flex-col items-center justify-center gap-0.5 text-xs transition-colors hover:text-[#4e000e] focus-visible:rounded-xl focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-700 ${active ? "text-[#831317]" : "text-[#b2b2b2]"}`}
      {...props}
    >
      <span
...
export default function BottomNav({
  ...
  return (
    <nav
      ...
      className={`fixed right-5 bottom-[calc(20px+env(safe-area-inset-bottom))] left-5 z-50 mx-auto h-[68px] max-w-[390px] ${className}`}
    >
      <GlassNavBackground />
