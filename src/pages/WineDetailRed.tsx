...
export default function WineDetailRed() {
  ...
  return (
    <div className="w-screen overflow-hidden bg-white pt-[env(safe-area-inset-top)] font-pretendard text-[#0d0d0d]" data-node-id="1546:5755">
      ...
      <div className="absolute top-[169px] right-5 z-[2] flex w-[59.302%] flex-col items-end">
        ...
        <p className="wine-detail-name-en mt-[5px] w-full">{wine.nameEn}</p>
        <h2 className="wine-detail-name-ko max-w-[270px]">{wine.nameKo}</h2>
        <p className="mt-1 text-[22px] leading-[1.2] font-bold whitespace-nowrap text-[#831317]">{formatPrice(wine.price)}</p>
      ...
      <div className="absolute top-[504.36px] left-[19.302%] z-[1] flex aspect-[373.32/287.943] h-auto w-[86.819%] items-center justify-center">
      ...
      <main className="relative mt-[676px] w-full overflow-hidden px-5 pb-10">
        <section className="wine-detail-basic flex w-full flex-col">
          ...
          <div className="mt-5 flex items-stretch gap-3"><span className="w-[3px] shrink-0 bg-[#831317]" /><p className="min-w-0 flex-1 text-[12px] leading-[1.6] tracking-[-0.24px] text-[#595959]">{wine.description}</p></div>
        </section>
