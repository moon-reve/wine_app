...
function Splash() {
  ...
  return (
    <main
      className="relative h-dvh w-screen overflow-hidden bg-[#f3f0e7] text-black"
      aria-label="Wine Sippers 스플래시 화면"
      data-node-id="1546:7747"
    >
      <div className="absolute top-1/2 left-1/2 aspect-[430/932] w-[min(100vw,calc(100dvh*430/932))] -translate-x-1/2 -translate-y-1/2">
        <video
          ref={videoRef}
        ...
        <img
          className="pointer-events-none absolute top-[12.66%] left-1/2 z-10 h-auto w-[54.65%] max-w-[235px] -translate-x-1/2"
          src={wineSippersLogo}
          alt="Wine Sippers"
          width="235"
          height="45"
        ...
        <div className="pointer-events-none absolute top-[85.3%] left-0 z-10 w-full text-center">
          <p
